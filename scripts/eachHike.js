//we use "new URL" to create a url object
//we use the "searchParams.get()" function to parse the "id" out.
...
function populateReviews() {
    ...
    let hikeName = params.searchParams.get("hikeName"); //get value for key "hikeName
